...
struct sidebar
{
	...
	// therefore, the total number of buttons is dynamic and depends on the shapes and children that the user has specified.
	
	// this indicates the user's position in the top buttons.
	// e.g., if topButtonsPosition = 0, the left-most button is the 'F' button.
	// e.g., if topButtonsPosition = 1, the 'F' button is not displayed (it has been moved left and behind the '<< left button').
	...
	// This is done so that letters and numbers can be pasted quickly without having to be rendered each and every time.
	// These will point to surfaces that contain the numbers 0 through 9 respectively.

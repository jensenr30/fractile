...
#define color_mix(color1, color2)                                                                  \
    (((((0xff000000 & color1) >> 1) + ((0xff000000 & color2) >> 1)) & 0xff000000) |                \
     ((((0xff0000 & color1) + (0xff0000 & color2)) >> 1) & 0xff0000) |                             \
     ((((0xff00 & color1) + (0xff00 & color2)) >> 1) & 0xff00) |                                   \
     ((((0xff & color1) + (0xff & color2)) >> 1) & 0xff))

// #define color_mix_weighted(color1, color2, weight1, weight2) (  ((((color1>>24)*weight1 +
// (color2>>24)*weight2)/(weight1 + weight2))<<24)  |  (((((color1>>16)&0xff)*weight1 +
// ((color2>>16)&0xff)*weight2)/(weight1 + weight2))<<16)  |  (((((color1>>8)&0xff)*weight1 +
// ((color2>>8)&0xff)*weight2)/(weight1 + weight2))<<8)  |  (((color1&0xff)*weight1 +
// (color2&0xff)*weight2)/(weight1 + weight2))  )
Uint32 color_mix_weighted(
    unsigned int color1, unsigned int color2, unsigned int weight1, unsigned int weight2
);
